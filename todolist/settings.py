...
DATABASES = {
    'default': {
        ...
        'HOST': hostString,  # You can use a different host if your MySQL server is on a remote machine.
        'PORT': portString,  # Leave this empty to use the default MySQL port (3306).
    }
}
